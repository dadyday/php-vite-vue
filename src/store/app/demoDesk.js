...
import AnalyticsCongratulations from "@pages/start/AnalyticsCongratulations.vue";
import AnalyticsOrderStatistics from "@pages/start/AnalyticsOrderStatistics.vue";
import AnalyticsProfitReport from "@pages/start/AnalyticsProfitReport.vue";
import AnalyticsTotalRevenue from "@pages/start/AnalyticsTotalRevenue.vue";
import AnalyticsFinanceTabs from "@pages/start/AnalyticsFinanceTab.vue";
import AnalyticsTransactions from "@pages/start/AnalyticsTransactions.vue";
import CardStatisticsVertical from "@sneat/components/cards/CardStatisticsVertical.vue";
